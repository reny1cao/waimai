  ...
  render() {
    ...
    if (this.state.editing === false) {
      ...
      return (
        <TableRow className="user" key={user.name}>
          <TableCell component="th" scope="row">
            <Input name="name" value={user.name} onChange={handleChangeEdit} />
          </TableCell>
          ...
          <TableCell component="th" scope="row">
            <FormControl>
              <Select onChange={onChangeDropdown} value={user.deliveryArea}>
          ...
          <TableCell component="th" scope="row">
            <Button
              variant="btn btn-secondary btn-sm"
              className="button"
              onClick={removeUser.bind(this, AdminComponent, user)}
            >
              Delete User
            </Button>
            <Button
              variant="btn btn-secondary btn-sm"
              onClick={editUser.bind(this, AdminComponent, user, this)}
              className="button"
            >
              Save User
            </Button>
